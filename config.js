...
if (!gg) {
  gg = "917249362297,918092300145";   // You can Change this number //
}
...
global.mongodb = process.env.MONGODB || "mongodb+srv://aimhacker2144:SANNY2144@cluster0.gkg4gpb.mongodb.net/?retryWrites=true&w=majority";
global.sessionId = process.env.SESSION_ID || "ok";
global.prefa = process.env.PREFIX || ".";
global.tenorApiKey =
  process.env.TENOR_API_KEY || "AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c";
global.packname = process.env.PACKNAME || `ANONYMOUS`;
global.author = process.env.AUTHOR || "by:SANNY";
